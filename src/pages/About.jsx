      ...
      <section
        ...
        <div className="flex items-center justify-center h-full w-full bg-black-900 bg-opacity-25 text-sm/">
          <div className="text-center">
            <h1 className="text-4xl md:text-6xl font-bold text-amber-600">About Our Faculty</h1>
            <br />
            <h2 className="text-2xl md:text-4xl font-semibold text-teal-400">Vocational and Technical Education</h2>
            <p className="mt-1 text-lg md:text-xl">Building Skills for Tomorrow's Nigeria.</p>
          </div>
        </div>
      </section>
      ...
      <section className=" bg-gray-50">
        <div className=" mx-auto px-6 bg-green-900 bg-opacity-50 rounded-lg shadow-lg p-12">
          <div className="text-center mb-1">
            ...
            <p className="text-orange-500 font-bold mt-4 mb-10">A journey through our milestones and achievements.</p>
          </div>
          <div className="bg-green-100 rounded-lg shadow-lg p-8">
            <p className="text-gray-800 text-justify">
              The Faculty which started off as Department of Vocational Teacher Education was one of the earliest departments in the University of Nigeria, Nsukka established in 1962. It was given its original mandate under Ford Foundation Project Grant No. 640-0475 for $380,000 in 1964. From inception, it was one of the three departments that made up the faculty of Education.The then Department of Vocational Teacher Education was made up of four broad units, namely; Agricultural Education, Business Education, Home Economics Education and Industrial Technical Education. Each of the four initial units of the Department had only a few students then and were, therefore grouped together into one department with the understanding that the Units would become full-fledged department when they had more students. The first head of Department was Professor Agusiobo.The Department was the pioneer Department of Vocational and Technical Education in Nigeria. As a result, almost all the institutions that run Vocational and Technical Education programmes in Nigeria at University, Polytechnic and College of Education levels are administered by the products of this Department.
              <br /> <br />
              In 1985 Computer Education unit was introduced. <span className="font-bold text-green-900">The Faculty was created in July 2015.</span> She offers both undergraduate and postgraduate programme in the six occupational areas of Agricultural & Bioresources Education, Business Education, Computer & Robotics Education, Home Economics & Hospitality Management Education, Industrial Technical Education and Vocational and Entrepreneurship Education that serves the entire faculty. The Faculty of Vocational Teacher Education, University of Nigeria, Nsukka has achieved huge successes in the face of overwhelming odds in the past 50 years. It has produced competent and vocationally skilled teachers that work in all areas of life in Nigeria and other parts of the world.
              <br /> <br />
              ...
              <br />
              Since the inception of the Faculty, it has collaborated fully with the Faculty of Education in affiliating most of her programmes with other tertiary institutions in Nigeria. This was one of the ways of ensuring the spread of the programme to the other parts of the country.
              <br /> <br />
              <span className="font-bold text-green-800">Some of the affiliated institutions are:</span>
              <br />
              <ul className="list-disc pl-5">
                <li>School of Technical Education at Yaba College of Technology, Yaba.
                  School for Vocational Technical Education at College of Education, Ikerekiti in Ekiti State.</li>
                <li>School of Vocational and Technical Education, Alvan Ikoku Federal College of Education, Owerri</li>
                <li>Federal College of Education (Technical) Omoku, and</li>
                <li>School of Vocational and Technical Education, Nwafor Orizu College of Educaiton Nsugbe.</li>
              </ul>
              <br />
      ...
      <div className="relative w-full h-full transition-transform duration-700 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)]">
        ...
        <div className="absolute w-full h-full [backface-visibility:hidden]">
          <div className="bg-green-900 rounded-2xl shadow-lg p-8 h-full flex flex-col justify-center items-center">
            <h3 className="text-2xl font-bold text-gray-200 mb-4">{frontTitle}</h3>
    ...
    <section className="py-20 bg-gray-50">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-green-950">Our Mission & Vision</h2>
          <p className="text-gray-900 mt-4">The core principles that guide our faculty.</p>
        </div>
...
const FacultyValues = () => {
  const values = [
    { title: 'Excellence', description: 'Striving for the highest standards in teaching, research, and service.' },
    { title: 'Integrity', description: 'Upholding honesty and ethical principles in all our academic and professional endeavors.' },
    { title: 'Innovation', description: 'Fostering a culture of creativity, curiosity, and cutting-edge discovery.' },
    { title: 'Collaboration', description: 'Working together across disciplines to achieve common goals and drive progress.' },
  ];
    ...
    <section className="py-20 bg-white">
      <div className=" mx-auto px-6 bg-green-900 rounded-lg shadow">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-white pt-10">Our Core Values</h2>
          <p className="text-amber-500 font-bold mt-4">The principles that define our community.</p>
        </div>
        <div className="flex flex-wrap -mx-4">
...
const WhyChooseUs = () => {
  const reasons = [
    { title: 'World-Class Faculty', description: 'Learn from renowned experts and researchers who are leaders in their fields.' },
    { title: 'State-of-the-Art Facilities', description: 'Access modern laboratories, advanced equipment, and extensive research resources.' },
    { title: 'Vibrant Student Life', description: 'A supportive and diverse community with numerous clubs, events, and activities.' },
  ];

  return (
    <section className="py-20 bg-white">
      <div className="container mx-auto px-6">
        <h2 className="text-4xl font-bold text-center text-green-800 mb-12">Why Choose Us?</h2>
        <div className="flex flex-wrap -mx-4">
...
const ExploreDepartments = () => {
  const departments = [
    ...
    { name: 'Home Economics and Hospitality Management Education', link: '#departments' },
      ...
      <div className="container mx-auto px-6 text-center">
        ...
        <div className="flex flex-wrap justify-center">
          {departments.map((dept, index) => (
            <a key={index} href={dept.link} className="bg-white text-gray-900 font-bold rounded-full py-3 px-6 m-2 hover:bg-gray-900 hover:text-gray-100 transition duration-500 transform hover:scale-105">
              {dept.name}
            </a>
          ))}
        </div>
...
const PhotoCarousel = () => {
  ...
  return (
    <section className="py-20 bg-gray-100">
      <div className="container mx-auto px-6 text-center">
        <h2 className="text-4xl font-bold text-gray-800 mb-12">Glimpses of Our Faculty</h2>
          ...
          <div className="overflow-hidden rounded-lg shadow-2xl">
            <div className="flex transition-transform ease-in-out duration-500" style={{ transform: `translateX(-${currentIndex * 100}%)` }}>
              {images.map((src, index) => (
                <img key={index} src={src} alt={`Faculty event ${index + 1}`} className="w-full flex-shrink-0" />
              ))}
            </div>
          </div>
          <button onClick={prevSlide} className="absolute top-1/2 left-0 transform -translate-y-1/2 bg-white bg-opacity-50 hover:bg-opacity-75 p-3 rounded-full ml-4 focus:outline-none">
            &#10094;
          </button>
          <button onClick={nextSlide} className="absolute top-1/2 right-0 transform -translate-y-1/2 bg-white bg-opacity-50 hover:bg-opacity-75 p-3 rounded-full mr-4 focus:outline-none">
            &#10095;
          </button>
        </div>
      </div>
